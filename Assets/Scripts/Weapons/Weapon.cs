...
namespace BulletSync.Character
{
	...
	public class Weapon : WeaponBehaviour
	{
		...
		[Tooltip("Accuracy of the weapon while not aiming down sights")]
		[SerializeField]
		private float hipFireAccuracy = 1;
		...
		public override float GetHipfireSpread() => hipFireAccuracy;
		...
		public override void Fire()
		{
			...
			{
				float aimingSpread = scopeBehaviour.AdjustSpreadMultiplier(hipFireAccuracy);
				finalSpread = Random.Range(-aimingSpread, aimingSpread);
			}
			else
			{
				finalSpread = Random.Range(-hipFireAccuracy, hipFireAccuracy);
			}

			// Apply spreadMultiplier to the rotation.
			rotation *= Quaternion.Euler(0, finalSpread, 0);
